...
public class ProblemaMochilaPD implements ProblemaPDR<Multiset<ObjetoMochila>, Integer> {
	...
	public static ProblemaMochilaPD create(String fichero, Integer c) {
		...
		ProblemaMochilaPD.multiplicidadesMaximas = ProblemaMochila.getObjetosDisponibles().stream()
	...
	private Boolean constraints(Integer a) {
		...
		// return this.capacidadRestante-a*objetos.get(index).getPeso() >= 0; //otra
		// formulaci�n
	}
	 ...
	 * @param a
	 *            Una alternativa de this
	 * @return Una cota superior del valor de la soluci�n del problema this si se
	 *         escoge la alternativa a
	 */
