...
public class SolucionAfinidad implements SolucionBT {

	public static SolucionAfinidad create(Map<String, String> sol, Integer afinidadAcum) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((afinidadAcum == null) ? 0 : afinidadAcum.hashCode());
