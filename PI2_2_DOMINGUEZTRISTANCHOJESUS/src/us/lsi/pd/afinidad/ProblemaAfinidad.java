...
public class ProblemaAfinidad {
	...
	public static ProblemaAfinidad createEjemplo() {
		clientes = Lists.newArrayList(Cliente.create("Juan", 10, Sets2.newSet("Amparo", "Rosa")),
				...
				Cliente.create("Sonia", 12, Sets2.newSet("Marco")), Cliente.create("Marta", 12, Sets2.newSet("Marco")),
	 ...
	 * 
	 * Cada l�nea del fichero de texto tendr� la estructura: nombreCliente,
	 * franjaHoraria, trabajadororesAfines
	 * 
	 * Por su lado, trabajadoresAfines ser�n los nombres de los trabajadores
	 * separados por ;
	 * 
	 * @param file
	 *            El archivo para leer los datos
	...
	public static ProblemaAfinidad create(String file) {
		...
		Stream2.fromFile(file).map(x -> x.replace(" ", "")) // quitar espacios en blanco
