...
public class AlgoritmoPD<S,A> extends AbstractAlgoritmo {
	...
	/**
	 * @param p - Problema del que se quiere obtener la soluci�n parcial
	...
	/**
	 * @return N�mero de problemas resueltos
	 */
	...
	/**
	 * @pre el problema es de minimizaci�n o de maximizaci�n
	 * @param p Un problema
	 * @return Un �rbol con las alternativas que est�n dentro de la soluci�n
	 */
	 ...
	 * @return Una alternativa escogida al azar o todas ellas dependiendo del tama�o del problam
	 */
