...
public class Secuencia implements VirtualVertex<Secuencia, SecuenciaEdge> {
	...
	public static enum Accion{Anade, Cambia, Elimina, Avanza, Nada};
	...
	public Secuencia getNeighbor(Accion a){
		...
		case Anade: s = s.append(transformada.charAt(index));  index++ ; break;
	...
	private boolean testAccion(Accion a){
		...
		case Anade: r = index == tamCadena &&  index < tamTransformada? true : false ; break;
