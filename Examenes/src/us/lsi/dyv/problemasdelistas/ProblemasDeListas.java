...
public class ProblemasDeListas {
	...
	public static <T> Tuple2<Integer, Integer> reordenaMedianteBanderaHolandesa(List<T> lista, T pivote, Integer i,
			Integer j, Comparator<? super T> cmp) {
		int a, b, c;
		a = i;
		b = i;
		c = j;
	...
	public static <T> Integer reordenaSobrePivote(List<T> lista, T pivote, Integer i, Integer j,
	...
	private static <E> void mezcla(List<E> l1, int i1, int j1, List<E> l2, int i2, int j2, List<E> l3, int i3, int j3,
	...
	public static class SubSecuencia implements Comparable<SubSecuencia> {
		...
		public String toString() {
			return "SubSecuencia [from=" + from + ", to=" + to + ", getSuma()=" + getSuma() + "]";
		}
