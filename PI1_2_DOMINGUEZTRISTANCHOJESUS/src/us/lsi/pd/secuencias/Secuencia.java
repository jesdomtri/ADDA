...
public class Secuencia implements VirtualVertex<Secuencia, SecuenciaEdge> {
	...
	public static enum Accion{Anyade, Cambia, Elimina, Avanza, Nada};
	...
	public Secuencia getNeighbor(Accion a){
		...
		case Anyade: s = s.append(transformada.charAt(index));  index++ ; break;
	...
	private boolean testAccion(Accion a){
		...
		case Anyade: r = index == tamCadena &&  index < tamTransformada? true : false ; break;
