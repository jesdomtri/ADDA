...
public class ProblemaPuzzle {
	...
	/**
	 * @param d
	 *            Lista de valores del puzzle dados por filas de abajo arriba
	...
	private ProblemaPuzzle(Integer... d) {
		...
		if (d.length != ProblemaPuzzle.numFilas * ProblemaPuzzle.numFilas
				|| s.size() != ProblemaPuzzle.numFilas * ProblemaPuzzle.numFilas)
			throw new IllegalArgumentException();
	}
	...
	/**
	 * @param e
	 *            Puzzle con el que realizar la diferencia.
	 * @return El n�mero de casillas diferentes entre el par�metro <code> e </code>
	 *         y <code>this</code>
	 */
	...
	/**
	 * @param incx
	 *            desplazamiento del hueco en la coordenada x
	 * @param incy
	 *            desplazamiento del hueco en la coordenada y
	 * @return Un nuevo ProblemaPuzzle resultante de intercambiar el hueco con la
	 *         casilla que corresponda seg�n el incremento indicado por los
	 *         par�metros.
	 */
